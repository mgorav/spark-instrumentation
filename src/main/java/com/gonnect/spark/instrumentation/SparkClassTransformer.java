package com.gonnect.spark.instrumentation;
...
public class SparkClassTransformer implements ClassFileTransformer {
    ...
    SparkClassTransformer(Predicate<String> allowTransformationPredicate, BiConsumer<String, Long> registerFunction) {
    ...
    private static <T extends CtBehavior> void emit(T target) throws CannotCompileException {
        ...
        target.insertAfter("DurationTransformer.registerStartTime(\"" + target.getLongName() + "\", __startTime);");
    }
